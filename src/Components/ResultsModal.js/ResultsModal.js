      ...
      >
        ...
        <div className="modal-btns">
          ...
          <a
            ...
            href={`https://x.com/intent/tweet?text=I scored ${quizScore} out of ${questions.length} correct answers in the ${categoryName} category with ${difficulty} difficulty on Quizzical, Come and try it out: https://quizzical-ali.netlify.app/`}
            data-size="large"
          >
            Share on twitter
          </a>
